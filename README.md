...
| /plan-from-spec | 기획 문서를 docs/plans/prompt_plan.md로 변환 (입력 검증 5종) |
| /plan | planner 에이전트 호출, docs/plans/prompt_plan.md 저장 (overview 연동) |
...
| /next-task | docs/plans/prompt_plan.md에서 우선순위 기반 다음 태스크 추천 |
