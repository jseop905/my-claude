...
2. **문서 디렉터리 갱신 필요**: 새 모듈/파일 추가, 디렉터리 구조 변경
3. **인라인 주석 불일치**: 함수 시그니처 변경 시 주석/docstring 미갱신
...
4. docs/ 디렉터리가 있으면 관련 문서 확인

## 출력 형식

반드시 `$SESSION_WRAP_DIR/results/doc-updates.json`에 기록:
  ...
  "items": [
    {
      ...
      "description": "새 의존성이 추가됨. README의 Installation 섹션에 반영 필요.",
      "category": "user",
      "priority": "medium",
      "action": "README.md의 ## Installation 섹션에 새 의존성 추가",
